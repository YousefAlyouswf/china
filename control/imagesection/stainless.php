    ...
    <div id="page-wrapper">
        <div id='cssmenu'>
            <ul>
                ...
                <li class='active'><a href='stainless.php'>Stainless</a></li>
        ...
        <div id="page-inner">
            ...
            if (isset($_FILES['attachments'])) {
                ...
                } else if (move_uploaded_file($_FILES['attachments']['tmp_name'][0], "../../img/stainless/" . $targetFile)) {
                    $msg = array("status" => 1, "msg" => "File Has Been Uploaded", "path" => "../../img/stainless/" . $targetFile);
                    $connect->query("INSERT INTO stainless(path) VALUES ('$targetFile')");
                }
            ...
            $sql = "SELECT * FROM stainless";
            $result = mysqli_query($connect, $sql);
            while ($row = mysqli_fetch_array($result)) {
                echo '<a target="_blank" href="../../img/stainless/' . $row['path'] . '">';
                echo '<div class=" col-md-4 col-sm-6"><img src="../../img/stainless/' . $row['path'] . '"width="150" height="150" style="margin: 10px;"></a><a href="delete/delstainless.php?id=' . $row['id'] . '">Delete</a>';
