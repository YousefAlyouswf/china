    ...
    <div id="page-wrapper">
        <div id='cssmenu'>
            <ul>
                ...
                <li class='active'><a href='automobile.php'>Automobile</a></li>
        ...
        <div id="page-inner">
            ...
            if (isset($_FILES['attachments'])) {
                ...
                } else if (move_uploaded_file($_FILES['attachments']['tmp_name'][0], "../../img/automobile/" . $targetFile)) {
                    $msg = array("status" => 1, "msg" => "File Has Been Uploaded", "path" => "../../img/automobile/" . $targetFile);
                    $connect->query("INSERT INTO automobilephoto(path) VALUES ('$targetFile')");
                }
            ...
            $sql = "SELECT * FROM automobilephoto";
            $result = mysqli_query($connect, $sql);
            while ($row = mysqli_fetch_array($result)) {
                echo '<a target="_blank" href="../../img/automobile/' . $row['path'] . '">';
                echo '<div class=" col-md-4 col-sm-6"><img src="../../img/automobile/' . $row['path'] . '"width="150" height="150" style="margin: 10px;"></a><a href="delete/deleteauto.php?id=' . $row['id'] . '">Delete</a>';
