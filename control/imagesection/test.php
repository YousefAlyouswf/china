    ...
    <div id="page-wrapper">
        <div id='cssmenu'>
            <ul>
                ...
                <li class='active'><a href='test.php'>Test Equipment</a></li>
        ...
        <div id="page-inner">
            ...
            if (isset($_FILES['attachments'])) {
                ...
                } else if (move_uploaded_file($_FILES['attachments']['tmp_name'][0], "../../img/test/" . $targetFile)) {
                    $msg = array("status" => 1, "msg" => "File Has Been Uploaded", "path" => "../../img/test/" . $targetFile);
                    $connect->query("INSERT INTO test(path) VALUES ('$targetFile')");
                }
            ...
            while ($row = mysqli_fetch_array($result)) {
                echo '<a target="_blank" href="../../img/test/' . $row['path'] . '">';
                echo '<div class=" col-md-4 col-sm-6"><img src="../../img/test/' . $row['path'] . '"width="150" height="150" style="margin: 10px;"></a><a href="delete/deltest.php?id=' . $row['id'] . '">Delete</a>';
