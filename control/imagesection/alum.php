...
if(isset($_SESSION['log'])){
    ...
    <div id="page-wrapper" >
        <div id='cssmenu'>
            <ul>
                ...
                <li class='active'><a href='alum.php'>Aluminum</a></li>
    ...
    if (isset($_FILES['attachments'])) {
        ...
        else if (move_uploaded_file($_FILES['attachments']['tmp_name'][0], "../../img/aluminum/" . $targetFile)){
            $msg = array("status" => 1, "msg" => "File Has Been Uploaded", "path" => "../../img/aluminum/" . $targetFile);
            $connect->query("INSERT INTO aluminumphoto(path) VALUES ('$targetFile')");
        }
        echo "<meta https-equiv='refresh' content='0;url=''>";

        exit(json_encode($msg));
    }
    ?>
            <div class="container">
                <h1>Aluminum Section</h1>
                <div id="dropZone">
            ...
            <div id="files"></div>
                ...
                while ($row = mysqli_fetch_array($result)){
                    echo '<a target="_blank" href="../../img/aluminum/'.$row['path'].'">';
                    echo '<div class=" col-md-4 col-sm-6"><img src="../../img/aluminum/'.$row['path'].'"width="150" height="150" style="margin: 10px;"></a><a href="delete/deletealum.php?id='.$row['id'].'">Delete</a>';
