    ...
    <div id="page-wrapper">
        <div id='cssmenu'>
            <ul>
                ...
                <li class='active'><a href='valve.php'>Valve Body</a></li>
            </ul>
        </div>
        <div id="page-inner">
            <?php
            ...
            if (isset($_FILES['attachments'])) {
                ...
                } else if (move_uploaded_file($_FILES['attachments']['tmp_name'][0], "../../img/valve/" . $targetFile)) {
                    $msg = array("status" => 1, "msg" => "File Has Been Uploaded", "path" => "../../img/valve/" . $targetFile);
                    $connect->query("INSERT INTO valve(path) VALUES ('$targetFile')");
                }
            ...
            while ($row = mysqli_fetch_array($result)) {
                echo '<a target="_blank" href="../../img/valve/' . $row['path'] . '">';
                echo '<div class=" col-md-4 col-sm-6"><img src="../../img/valve/' . $row['path'] . '"width="150" height="150" style="margin: 10px;"></a><a href="delete/delvalve.php?id=' . $row['id'] . '">Delete</a>';
