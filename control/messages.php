        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <hr/>
                    ...
                    $sql = "select * from newmsg ORDER BY  id DESC";
                    $result = mysqli_query($connect, $sql);
                    echo '<h2>Messages</h2><br>';
                    $result1 = mysqli_query($connect, "SELECT * FROM newmsg ORDER BY  id DESC");
                    $num_rows1 = mysqli_num_rows($result1);
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '
                                <tr style="font-weight: bold; ">
                                    ...
                                    <td>' . $row['email'] . '</td>
                                    <td>' . $row['subject'] . '</td>
                                    <td><a class="button" href="readmessage.php?id=' . $row['id'] . '" </a><img  src="../img/templatesImage/read.png" height="20px" width="20px"> <a href="deletemsg.php?id=' . $row['id'] . '"  onclick="return  confirm(\'Are you sure you want to delete?\')"><img src="../img/templatesImage/delete.png" height="20px" width="20px"> </a></td>
                                </tr>
                             ';
                    }
                    ...
                    $result1 = mysqli_query($connect, "SELECT * FROM msg ORDER BY  id DESC");
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo '
                                <tr >   
                                    ...
                                    <td>' . $row['email'] . '</td>
                                    <td>' . $row['subject'] . '</td>
                                    <td><a href="readmessage.php?id=' . $row['id'] . '" </a><img src="../img/templatesImage/read.png" height="20px" width="20px"> <a href="deletemsg.php?id=' . $row['id'] . '" onclick="return  confirm(\'Are you sure you want to delete?\')"><img src="../img/templatesImage/delete.png" height="20px" width="20px"> </a></td>
                                </tr>
                              ';
                    }
                    echo '</table>';
