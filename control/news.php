                        ...
                        <th id="tr1">Delete</th></tr>';
                            ...
                            while ($row=mysqli_fetch_array($result)){
                                echo '<tr>
                                                     ...
                                                     <td ><a href="deletenews.php?id='.$row['id'].'" onclick="return  confirm(\'Are you sure you want to delete?\')"><img src="../img/templatesImage/delete.png" height="20px" width="20px"> </a> </td > ';
                            }
