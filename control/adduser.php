...
font-size: 16px;"><a href="../login.php" class="btn btn-danger square-btn-adjust">Logout</a></div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="adduser.php"><i></i> Users add / delete</a>
                    </li>
                    <li>
 ...
 />
                        ...
                        <button type="submit" name="addnewuser" class="btn btn-danger square-btn-adjust" style="background: #00CE6F">Add</button>
                    </form>
                </div>
                <?php
                if (isset($_POST['addnewuser'])) {
                    ...
                    if ($password == $repassword) {
                        ...
                        echo '<p id="error" style="color:green;">User added to database</p>';
                        //echo("<meta http-equiv='refresh' content='0'>");

                    } else {
                        echo '<h3 id="error">Password is not match</h3>';
                    }
                }
    ...
    <th>Register date</th>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<tr><td><a href="deleteuser.php?id=' . $row['id'] . '" onclick="return  confirm(\'Are you sure you want to delete?\')"><img src="../img/templatesImage/delete.png" height="20px" width="20px"> </a>' . $row['username'] . '</td><td>' . $row['date'] . '</td></tr>';
